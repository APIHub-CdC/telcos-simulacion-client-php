...
namespace TelcosSimulacion\Client\Api;
...
use TelcosSimulacion\Client\HeaderSelector;
use TelcosSimulacion\Client\ObjectSerializer;

class TelcosSimulacionApi
{
    ...
    {
        $returnType = '\TelcosSimulacion\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TelcosSimulacion\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TelcosSimulacion\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
